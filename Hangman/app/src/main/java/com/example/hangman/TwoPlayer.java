...
public class TwoPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s = intent.getStringExtra(MainActivity.EXTRA_WORD);

        initializeButtons();

        displayWord = findViewById(R.id.displayWord);
        image = findViewById(R.id.imageView);
        game = new HangmanGame(s, this);
    ...
    private void guessButton(String uppercase, String lowercase, Button button) {
        game.checkGuessTwoPlayer(uppercase, lowercase);
